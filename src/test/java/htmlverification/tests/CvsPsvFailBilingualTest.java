...
public class CvsPsvFailBilingualTest {

    protected HtmlGenerator htmlGenerator;
    protected VTP30Bilingual testCertificate;
    protected CertificatePageObject certificatePageObjectVTG30;
    protected CertificatePageObject certificatePageObjectVTG30W;

    public CvsPsvFailBilingualTest() {
        this.htmlGenerator = new HtmlGenerator(new Handlebars());
    }

    @Before
    public void setup() throws IOException {
        testCertificate = CvsCertificateTestDataProvider.getVtp30Bilingual();
